...
public class SeleniumOperations {
	...
	public static void open_chrome_loadpage_resize_close() {
	    ...
	    System.out.println("Hello from s223075053, Sudusinghe Wawwege Ishini Bhagya");
	    ...
	    // Open URL https://www.google.com using Selenium API.
	    System.out.println("Opening https://www.google.com");
	    driver.get("https://www.google.com");

	    // Resize the chromium browser window size to 640x480 and sleep for 2 seconds.
